...
- `massoft_client_rewrite2_fixed.py`
- `cap2_rewrite2_fixed.py`
...
python hiden/cap2_rewrite2_fixed.py --list-pvs -v
```
...
### Open experiment and start links
...
### Start scan and publish PV updates
