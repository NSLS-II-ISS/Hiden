...
from massoft_client_extended import MASsoftClientExtended, MASsoftConfig
from massoft_client import MASsoftTimeout, load_runtime_config
...
class RGAIOCExtended(PVGroup):
    # ------------------------------------------------------------------
    # Core workflow PVs (compatible with fixed IOC)
    # ------------------------------------------------------------------
